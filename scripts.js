...
const encounters = [
    ...
    {
        text: "Unfortunately, it's my first day on the job, so all I have is moldy bagels. Would you help me learn to make a cake?",
        choices: [
            {
                text: "Sure, I'd love to help!",
                result: "Great! Let's get started."
            },
            {
    ...
    {
        text: "I have no idea how to bake a cake, so I'm gonna need a recipe first."
    },
...

    {
        ...
        choices: [
            ...
            },
            {
                ...
                result: "Wrong! Those are all in the baking section."
            }
        ]
    },
...
function next() {
    ...
    if (currentEncounter < encounters.length) {
        ...
        screen.innerHTML = `
            <h1>End of this section!</h1>
            <p>More bakery adventures coming soon...</p>
        `;
...
function renderscram() {
  ...
  function renderWord() {
      ...
      screen.innerHTML = `
          ...
          <p class="sub">
              Word ${wi + 1} of ${words.length} — tap the letters in order to type.
          </p>
      ...
      slotsEl.innerHTML = word
          .split('')
          .map(() => `<div class="slot"></div>`)
          .join('');

      tilesEl.innerHTML = letters
          .map((l, i) => `<div class="tile" data-i="${i}">${l}</div>`)
          .join('');
          ...
          tile.addEventListener('click', () => {
              ...
              if (answer.length === word.length) {
                  ...
                  if (answer.join('') === word) {
                      ...
                      // Make sure you have a toast() function before using this
                      // toast('Nice! ' + word);
